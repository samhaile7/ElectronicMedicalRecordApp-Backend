...
public class Patient {
	...
	public Patient(String firstName, String lastName, LocalDate birthDate, LocalDate admitDate, int pulseRate,
			int respirationRate, int temperature, int sPO2, int partialThromboplastinTime, int systolicBloodPressure,
			int diastolicBloodPressure, int mobilityStatusId) {
	...
	public String toString() {
		return "Patient{" + "patientId=" + patientId + ", firstName='" + firstName + '\'' + ", lastName='" + lastName
				+ '\'' + ", birthDate=" + birthDate + ", admitDate=" + admitDate + ", pulseRate=" + pulseRate
				+ ", respirationRate=" + respirationRate + ", temperature=" + temperature + ", sPO2=" + sPO2
				+ ", partialThromboplastinTime=" + partialThromboplastinTime + ", systolicBloodPressure="
				+ systolicBloodPressure + ", diastolicBloodPressure=" + diastolicBloodPressure + ", mobilityStatusId="
				+ mobilityStatusId + '}';
	}
